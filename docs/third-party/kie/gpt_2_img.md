...
> Generate content using the Gpt Image 2 Text To Image model

## Overview

This document describes how to use the Gpt Image 2 Text To Image model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `gpt-image-2-text-to-image` |
...
|----------|-------|-------------|
| **Format** | `gpt-image-2-text-to-image` | The exact model identifier for this API |
...
- **Default Value**: `"Generate an image of a funny guy that is live-streaming on tiktok and has 3d cartoon characters around him - design something funny."`
...
```json
{
  ...
  "input": {
    "prompt": "Generate an image of a funny guy that is live-streaming on tiktok and has 3d cartoon characters around him - design something funny.",
    "aspect_ratio": "auto",
    "nsfw_checker": true
  }
}
...
```json
{
  ...
  "data": {
    ...
    "model": "gpt-image-2-text-to-image",
    "state": "waiting",
    "param": "{\"model\":\"gpt-image-2-text-to-image\",\"input\":{\"prompt\":\"Generate an image of a funny guy that is live-streaming on tiktok and has 3d cartoon characters around him - design something funny.\",\"aspect_ratio\":\"auto\",\"nsfw_checker\":true}}",
    "resultJson": "{\"resultUrls\":[\"https://static.aiquickdraw.com/tools/example/1776781849575_UFEhXUjC.png\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
